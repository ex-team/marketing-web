...
function ThematicSection(props: Props) {
  ...
  const thematicSliders = props.dataSlider;
  const [loading, setLoading] = useState(true);

  const glide = new Glide('#thematicSlider', {
    type: 'slider',
    startAt: 0,
    autoplay: 15000,
    perView: 2,
      ...
      <div className="container">
        <div className="content-section">
          <div className="p-grid">
            <div className="p-col-12 p-md-6 p-lg-4 thematic-description">
              {loading ? (
            ...
            <div className="p-col-12 p-md-6 p-lg-8 thematic-picture">
              <div className="slider-banner">
                <div className="glide-wrapper">
                  <div className="glide" id="thematicSlider">
                    <div className="glide__track" data-glide-el="track">
                      <ul className="glide__slides p-align-center">
                        {thematicSliders.map((data, idx) => {
                          if (loading) {
                            return (
